  ...
  return (
    <section className="relative z-10 py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div
          ref={headerRef}
          className={`text-center mb-12 sm:mb-16 lg:mb-20 transition-all duration-1000 ${headerVisible
  ...
  return (
    ...
    <div className="space-y-4 sm:space-y-6">
      {items.map((item, idx) => (
        ...
        >
          <Card className="bg-gray-900/50 border-gray-800 hover:bg-gray-900/70 transition-colors duration-300 hover:scale-[1.02]">
            <CollapsibleTrigger asChild>
              <div className="p-4 sm:p-6 cursor-pointer w-full">
                <div className="absolute right-3 sm:right-4 top-3 sm:top-4 rounded-md p-1 font-bold text-cyan-500 hover:text-cyan-300 hover:bg-white/10 transition-colors duration-200">
                  {openMap[idx] ? (
                ...
                <h3 className="text-lg sm:text-xl text-gray-300 font-semibold pr-8 sm:pr-12 leading-tight">
                  {item.q}
                </h3>
              </div>
            </CollapsibleTrigger>
